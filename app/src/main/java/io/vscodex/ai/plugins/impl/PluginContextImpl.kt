 ...
 */
package io.vscodex.ai.plugins.impl
...
import io.vscodex.ai.activities.EditorActivity
import io.vscodex.ai.app.rootView
import io.vscodex.ai.core.EventManager
import io.vscodex.ai.core.MenuManager
import io.vscodex.ai.core.PanelManager
import io.vscodex.ai.core.components.DraggableFloatingPanel
...
import io.vscodex.ai.keyboard.model.Command
...
import io.vscodex.ai.plugins.Editor
import io.vscodex.ai.plugins.PluginContext
import io.vscodex.ai.plugins.Workspace
import io.vscodex.ai.plugins.command.EditorCommand
import io.vscodex.ai.plugins.dialog.DialogButtonClickListener
import io.vscodex.ai.plugins.editor.Position
import io.vscodex.ai.plugins.event.EventListener
import io.vscodex.ai.plugins.event.EventType
import io.vscodex.ai.plugins.menu.MenuItem
import io.vscodex.ai.plugins.network.HttpResponse
import io.vscodex.ai.plugins.panel.ComposeFactory
import io.vscodex.ai.plugins.panel.Panel
import io.vscodex.ai.plugins.panel.ViewFactory
import io.vscodex.ai.plugins.panel.ViewUpdater
...
class PluginContextImpl(
    ...
    override fun addMenu(menuItem: MenuItem) {
        ...
        menuManager.addMenu(
            io.vscodex.ai.core.menu.MenuItem(
                menuItem.title,
                menuItem.id,
                visible = true,
                enabled = true,
