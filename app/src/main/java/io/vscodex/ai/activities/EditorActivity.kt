...
import io.vscodex.ai.APP_EXTERNAL_DIR
...
import io.vscodex.ai.activities.base.ObserveLifecycleEvents
import io.vscodex.ai.app.DoNothing
import io.vscodex.ai.app.MONACO_EDITOR_ARCHIVE
import io.vscodex.ai.app.noLocalProvidedFor
import io.vscodex.ai.app.rootView
...
import io.vscodex.ai.core.settings.Settings.General.rememberEnableGestureInDrawer
...
import io.vscodex.ai.events.OnCreateFileEvent
import io.vscodex.ai.events.OnCreateFolderEvent
...
import io.vscodex.ai.plugins.PluginLoader
import io.vscodex.ai.plugins.impl.PluginContextImpl
import io.vscodex.ai.ui.components.ai.GenerateContentDialog
import io.vscodex.ai.ui.screens.editor.EditorScreen
import io.vscodex.ai.ui.screens.editor.EditorViewModel
import io.vscodex.ai.ui.screens.editor.components.EditorDrawerSheet
import io.vscodex.ai.ui.screens.editor.components.EditorTopBar
import io.vscodex.ai.ui.screens.editor.components.view.CodeEditorView
import io.vscodex.ai.ui.screens.file.FileExplorerViewModel
import io.vscodex.ai.utils.createNomediaFile
import io.vscodex.ai.plugins.event.FileCreateEvent
