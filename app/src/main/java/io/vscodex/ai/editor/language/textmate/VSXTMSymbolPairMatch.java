...
public class VSXTMSymbolPairMatch extends SymbolPairMatch {
  ...
  public VSXTMSymbolPairMatch(VSXTMLanguage language) {
  ...
  public void updatePair() {
    ...
    for (var pair : mergePairs) {
      putPair(pair.open, new SymbolPair(pair.open, pair.close, new VSXTMSymbolPairMatch.SymbolPairEx(pair)));
    }
  }
