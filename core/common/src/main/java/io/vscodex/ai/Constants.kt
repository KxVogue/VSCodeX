...
val APP_EXTERNAL_DIR = "${PathUtils.getExternalStoragePath()}/VSCodeX"

const val ORGANIZATION_NAME = "VSCodeX"
const val APPLICATION_REPOSITORY_NAME = "VSCodeX"
