...
package io.vscodex.ai.editor.textaction
...
val actionItems = listOf(
    ...
    EditorTextActionItem(
        id = R.string.editor_action_ai_rewrite,
        icon = Icons.Outlined.AutoAwesome,
        description = "AI Rewrite: refactor or improve the selected code.",
        visible = false    // shown only when AI Rewrite is enabled in Settings
    )
)
